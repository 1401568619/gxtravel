...
import com.gxtravel.utils.MD5Utils;
import com.gxtravel.utils.MailUtils;
            ...
            if(k==0) {
                ...
                if (i > 0) {
                    ...
                    String emailMsg = "恭喜您注册成功，请点击下面的连接进行激活账户"
                            + "<a href='http://localhost:8080/gxtravel/active?activeCode=" + activeCode + "'>"
                            + "http://localhost:8080/gxtravel/active?activeCode=" + activeCode + "</a>";
                    try {
