		...
		<form name=alipayment action=${pageContext.request.contextPath }/pay/alipay.trade.page.pay.jsp method=post
			...
			<div id="body1" class="show" name="divcontent">
				<dl class="content">
					<dt>订单号 ：</dt>
					<dd>
						<input id="WIDout_trade_no" value="${order.no}" name="WIDout_trade_no" />
					</dd>
					<hr class="one_line">
					<dt>下单人 ：</dt>
					<dd>
						<input id="WIDsubject" value="${order.user.name}" name="WIDsubject" />
					</dd>
					<hr class="one_line">
					<dt>付款金额 ：</dt>
					<dd>
						<input id="WIDtotal_amount" value="${order.paid}" name="WIDtotal_amount" />
					</dd>
					<hr class="one_line">
					<dt>下单时间：</dt>
					<dd>
						<input id="WIDbody" value="${ordertime}" name="WIDbody" />
					</dd>
					<hr class="one_line">
					<dt></dt>
					<dd id="btn-dd">
...
<script language="javascript">
	...
	function GetDateNow() {
		...
		document.getElementById("WIDsubject").value = "小米手机";
		document.getElementById("WIDtotal_amount").value = "2000";
	}
	//GetDateNow();
</script>
</html>