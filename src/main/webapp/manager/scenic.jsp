                            ...
                            <div class="form-group">
                                <label for="edit_theme">景点主题</label>
                                    <select	class="form-control" id="edit_theme" placeholder="景点主题" name="theme">
                                        ...
                                        <option value="自然山水" <c:if test="${theme == '自然山水'}"> selected</c:if>>
                                            自然山水
                                        </option>
                                        <option value="田园风光" <c:if test="${theme == '田园风光'}"> selected</c:if>>
                                            田园风光
                                        </option>
                                        <option value="沙滩海岸" <c:if test="${theme == '沙滩海岸'}"> selected</c:if>>
                                            沙滩海岸
                                        </option>
                                        <option value="主题乐园" <c:if test="${theme == '主题乐园'}"> selected</c:if>>
                                            主题乐园
                                        </option>
                                        <option value="名胜古迹" <c:if test="${theme == '名胜古迹'}"> selected</c:if>>
                                            名胜古迹
                                        </option>
                                    </select>
                            </div>
