            ...
            <ul class="nav" id="side-menu">
                <li class="sidebar-search">
                    <div class="input-group custom-search-form">
                        <input type="text" disabled="disabled" class="form-control" placeholder="广西旅行资讯网主页">
                ...
                <li><a href="${pageContext.request.contextPath }/managerScore"><i
                        class="fa fa-dashboard fa-fw"></i> 评分管理</a></li>
