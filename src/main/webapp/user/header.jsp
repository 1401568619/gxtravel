...
<div class="container-fluid">
    <div class="col-md-1" style="padding-top: 4px">
        <img style="height: 50px;width: 110px" src="${pageContext.request.contextPath}/image/logo1.png" />
    </div>
    <div class="col-md-4" style="padding-left: 0px;padding-top: 4px">
        <img src="${pageContext.request.contextPath}/image/gxlogo.png" />
    </div>
    <div class="col-md-3">
        ...
        <div class="container-fluid">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                <ul class="nav navbar-nav">
                    ...
                    <li><a href="${pageContext.request.contextPath }/getRecommend">个性推荐</a></li>
                ...
                <form class="navbar-form navbar-right" action="${pageContext.request.contextPath }/getScenicPageForUser" role="search" method="get">
                    <div class="form-group">
                        <input type="text" class="form-control" placeholder="Search" id="search" name="search" value="${searchParameter}">
                    </div>
