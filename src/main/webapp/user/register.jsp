...
<body>
	...
	<div class="container"
		style="width: 98%; background: url('${pageContext.request.contextPath }/image/zhucedenglu.PNG');">
		<div class="row">
			<div class="col-md-2"></div>
			<div class="col-md-8" style="background: #fff; width: 680px; padding: 40px 80px; margin: 30px; border: 7px solid #ccc;">
				<font>用户注册</font>
