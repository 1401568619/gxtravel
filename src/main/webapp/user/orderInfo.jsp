            ...
            <form id="myform" class="form-horizontal" action="${pageContext.request.contextPath }/payForOrder" method="post" style="margin-top: 5px;">
                ...
                <div class="form-group">
                    ...
                    <div class="col-sm-9" style="padding-top: 5px">
                        ...
                        <img src="${pageContext.request.contextPath }/image/bank_img/icbc.bmp" style="width: 30%" align="middle" />&nbsp;&nbsp;&nbsp;&nbsp;
                        <input type="radio" name="pd_FrpId" value="CCB-NET-B2C" />
                        <img src="${pageContext.request.contextPath }/image/bank_img/ccb.bmp" style="width: 30%" align="middle" />
                    </div>
                </div>
                <div class="form-group">
